              ...
              <div className="grid grid-cols-3 gap-2">
                {LEVELS.map((l) => (
                  <button
                    ...
                    className={cn("flex flex-col items-center gap-1 p-3 rounded-xl border-2 transition-all duration-200 text-center", level === l.id ? "border-primary bg-primary/10 text-primary" : "border-white/10 text-white/50 hover:border-white/25")}
