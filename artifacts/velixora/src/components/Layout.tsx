...
import { 
  ...
  Languages, Globe, Settings, Menu, X, ChevronLeft, ChevronRight
} from "lucide-react";
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="p-4 flex items-center justify-between shrink-0">
        {!collapsed && (
          <Link href="/" className="font-sans font-bold text-xl tracking-tight bg-clip-text text-transparent gradient-violet-cyan select-none flex items-center gap-2">
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden relative">
      ...
      <motion.aside 
        ...
        className="hidden md:block h-full glass border-r border-border/50 z-20 shrink-0"
      >
        <SidebarContent />
      </motion.aside>
      ...
      <motion.aside
        ...
        className="fixed inset-y-0 left-0 w-64 glass border-r border-border/50 z-50 md:hidden shadow-2xl"
      >
        <SidebarContent />
      </motion.aside>
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative z-10">
        ...
        <header className="md:hidden flex items-center justify-between p-4 glass border-b border-border/50 shrink-0">
          <Link href="/" className="font-sans font-bold text-lg tracking-tight bg-clip-text text-transparent gradient-violet-cyan select-none flex items-center gap-2">
            <div className="w-5 h-5 rounded hover:scale-105 transition-transform gradient-violet-cyan flex items-center justify-center text-white text-[10px]">V</div>
            VELIXORA
          </Link>
