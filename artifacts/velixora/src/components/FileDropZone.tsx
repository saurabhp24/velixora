...
import { UploadCloud, File as FileIcon, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div
        ...
        onDrop={handleDrop}
        className={`w-full max-w-2xl aspect-video rounded-xl border-2 border-dashed flex flex-col items-center justify-center p-8 text-center cursor-pointer transition-all duration-300 glass ${
          isDragging
