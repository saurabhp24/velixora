            ...
            <div className="p-5 rounded-xl border border-white/10 bg-white/5 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  />
                  <button onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors" data-testid="toggle-password-btn">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className={cn("bg-background/50", mismatch ? "border-destructive" : "")}
